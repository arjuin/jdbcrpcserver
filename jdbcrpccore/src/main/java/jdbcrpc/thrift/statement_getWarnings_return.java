...
public class statement_getWarnings_return implements org.apache.thrift.TBase<statement_getWarnings_return, statement_getWarnings_return._Fields>, java.io.Serializable, Cloneable, Comparable<statement_getWarnings_return> {
  ...
  public List<RSQLWarning> warnings; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.WARNINGS, new org.apache.thrift.meta_data.FieldMetaData("warnings", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, RSQLWarning.class))));
  ...
  public statement_getWarnings_return(statement_getWarnings_return other) {
    if (other.isSetWarnings()) {
      List<RSQLWarning> __this__warnings = new ArrayList<RSQLWarning>(other.warnings.size());
      for (RSQLWarning other_element : other.warnings) {
        __this__warnings.add(new RSQLWarning(other_element));
      }
  ...
  public java.util.Iterator<RSQLWarning> getWarningsIterator() {
    return (this.warnings == null) ? null : this.warnings.iterator();
  }

  public void addToWarnings(RSQLWarning elem) {
    if (this.warnings == null) {
      this.warnings = new ArrayList<RSQLWarning>();
    }
  ...
  public statement_getWarnings_return setWarnings(List<RSQLWarning> warnings) {
    this.warnings = warnings;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case WARNINGS:
      if (value == null) {
        ...
        setWarnings((List<RSQLWarning>)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.warnings = new ArrayList<RSQLWarning>(_list32.size);
                RSQLWarning _elem33;
                for (int _i34 = 0; _i34 < _list32.size; ++_i34)
                {
                  _elem33 = new RSQLWarning();
                  _elem33.read(iprot);
                  struct.warnings.add(_elem33);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, statement_getWarnings_return struct) throws org.apache.thrift.TException {
      ...
      if (struct.warnings != null) {
        oprot.writeFieldBegin(WARNINGS_FIELD_DESC);
        {
          ...
          for (RSQLWarning _iter35 : struct.warnings)
          {
            _iter35.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetWarnings()) {
        {
          ...
          for (RSQLWarning _iter36 : struct.warnings)
          {
            _iter36.write(oprot);
          }
        }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.warnings = new ArrayList<RSQLWarning>(_list37.size);
          RSQLWarning _elem38;
          for (int _i39 = 0; _i39 < _list37.size; ++_i39)
          {
            _elem38 = new RSQLWarning();
            _elem38.read(iprot);
            struct.warnings.add(_elem38);
          }
        }
        struct.setWarningsIsSet(true);
      }
