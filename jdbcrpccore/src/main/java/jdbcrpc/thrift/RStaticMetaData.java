...
public class RStaticMetaData implements org.apache.thrift.TBase<RStaticMetaData, RStaticMetaData._Fields>, java.io.Serializable, Cloneable, Comparable<RStaticMetaData> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("RStaticMetaData");
  ...
  static {
    schemes.put(StandardScheme.class, new RStaticMetaDataStandardSchemeFactory());
    schemes.put(TupleScheme.class, new RStaticMetaDataTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(RStaticMetaData.class, metaDataMap);
  }
   ...
   */
  public RStaticMetaData(RStaticMetaData other) {
  ...
  public RStaticMetaData deepCopy() {
    return new RStaticMetaData(this);
  }
  ...
  public RStaticMetaData setDatabaseMajorVersion(int databaseMajorVersion) {
    this.databaseMajorVersion = databaseMajorVersion;
    setDatabaseMajorVersionIsSet(true);
    return this;
  }
  ...
  public RStaticMetaData setDatabaseMinorVersion(int databaseMinorVersion) {
    this.databaseMinorVersion = databaseMinorVersion;
    setDatabaseMinorVersionIsSet(true);
    return this;
  }
  ...
  public RStaticMetaData setDatabaseProductName(String databaseProductName) {
    this.databaseProductName = databaseProductName;
    return this;
  }
  ...
  public RStaticMetaData setDatabaseProductVersion(String databaseProductVersion) {
    this.databaseProductVersion = databaseProductVersion;
    return this;
  }
  ...
  public RStaticMetaData setDefaultTransactionIsolation(int defaultTransactionIsolation) {
    this.defaultTransactionIsolation = defaultTransactionIsolation;
    setDefaultTransactionIsolationIsSet(true);
    return this;
  }
  ...
  public RStaticMetaData setIdentifierQuoteString(String identifierQuoteString) {
    this.identifierQuoteString = identifierQuoteString;
    return this;
  }
  ...
  public RStaticMetaData setSupportsCatalogsInTableDefinitions(boolean supportsCatalogsInTableDefinitions) {
    this.supportsCatalogsInTableDefinitions = supportsCatalogsInTableDefinitions;
    setSupportsCatalogsInTableDefinitionsIsSet(true);
    return this;
  }
  ...
  public RStaticMetaData setSupportsSavepoints(boolean supportsSavepoints) {
    this.supportsSavepoints = supportsSavepoints;
    setSupportsSavepointsIsSet(true);
    return this;
  }
  ...
  public RStaticMetaData setSupportsSchemasInDataManipulation(boolean supportsSchemasInDataManipulation) {
    this.supportsSchemasInDataManipulation = supportsSchemasInDataManipulation;
    setSupportsSchemasInDataManipulationIsSet(true);
    return this;
  }
  ...
  public RStaticMetaData setSupportsSchemasInTableDefinitions(boolean supportsSchemasInTableDefinitions) {
    this.supportsSchemasInTableDefinitions = supportsSchemasInTableDefinitions;
    setSupportsSchemasInTableDefinitionsIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof RStaticMetaData)
      return this.equals((RStaticMetaData)that);
    return false;
  }

  public boolean equals(RStaticMetaData that) {
    if (that == null)
      return false;
  ...
  public int hashCode() {
    ...
    boolean present_databaseMajorVersion = true;
    list.add(present_databaseMajorVersion);
    if (present_databaseMajorVersion)
      list.add(databaseMajorVersion);

    boolean present_databaseMinorVersion = true;
    list.add(present_databaseMinorVersion);
    if (present_databaseMinorVersion)
      list.add(databaseMinorVersion);

    boolean present_databaseProductName = true && (isSetDatabaseProductName());
    list.add(present_databaseProductName);
    if (present_databaseProductName)
      list.add(databaseProductName);

    boolean present_databaseProductVersion = true && (isSetDatabaseProductVersion());
    list.add(present_databaseProductVersion);
    if (present_databaseProductVersion)
      list.add(databaseProductVersion);
    ...
    boolean present_identifierQuoteString = true && (isSetIdentifierQuoteString());
    list.add(present_identifierQuoteString);
    if (present_identifierQuoteString)
      list.add(identifierQuoteString);

    boolean present_supportsCatalogsInTableDefinitions = true;
    list.add(present_supportsCatalogsInTableDefinitions);
    if (present_supportsCatalogsInTableDefinitions)
      list.add(supportsCatalogsInTableDefinitions);

    boolean present_supportsSavepoints = true;
    list.add(present_supportsSavepoints);
    if (present_supportsSavepoints)
      list.add(supportsSavepoints);

    boolean present_supportsSchemasInDataManipulation = true;
    list.add(present_supportsSchemasInDataManipulation);
    if (present_supportsSchemasInDataManipulation)
      list.add(supportsSchemasInDataManipulation);

    boolean present_supportsSchemasInTableDefinitions = true;
    list.add(present_supportsSchemasInTableDefinitions);
    if (present_supportsSchemasInTableDefinitions)
      list.add(supportsSchemasInTableDefinitions);

    return list.hashCode();
  }

  @Override
  public int compareTo(RStaticMetaData other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("RStaticMetaData(");
    boolean first = true;
  ...
  private static class RStaticMetaDataStandardSchemeFactory implements SchemeFactory {
    public RStaticMetaDataStandardScheme getScheme() {
      return new RStaticMetaDataStandardScheme();
    }
  }

  private static class RStaticMetaDataStandardScheme extends StandardScheme<RStaticMetaData> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, RStaticMetaData struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, RStaticMetaData struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class RStaticMetaDataTupleSchemeFactory implements SchemeFactory {
    public RStaticMetaDataTupleScheme getScheme() {
      return new RStaticMetaDataTupleScheme();
    }
  }

  private static class RStaticMetaDataTupleScheme extends TupleScheme<RStaticMetaData> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, RStaticMetaData struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, RStaticMetaData struct) throws org.apache.thrift.TException {
