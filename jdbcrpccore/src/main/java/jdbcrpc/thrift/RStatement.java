...
public class RStatement implements org.apache.thrift.TBase<RStatement, RStatement._Fields>, java.io.Serializable, Cloneable, Comparable<RStatement> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("RStatement");
  ...
  static {
    schemes.put(StandardScheme.class, new RStatementStandardSchemeFactory());
    schemes.put(TupleScheme.class, new RStatementTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(RStatement.class, metaDataMap);
  }
   ...
   */
  public RStatement(RStatement other) {
  ...
  public RStatement deepCopy() {
    return new RStatement(this);
  }
  ...
  public RStatement setId(int id) {
    this.id = id;
    setIdIsSet(true);
    return this;
  }
  ...
  public RStatement setSql(String sql) {
    this.sql = sql;
    return this;
  }
  ...
  public RStatement setId_connection(int id_connection) {
    this.id_connection = id_connection;
    setId_connectionIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof RStatement)
      return this.equals((RStatement)that);
    return false;
  }

  public boolean equals(RStatement that) {
    if (that == null)
      return false;
  ...
  public int hashCode() {
    ...
    boolean present_id_connection = true;
    list.add(present_id_connection);
    if (present_id_connection)
      list.add(id_connection);

    return list.hashCode();
  }

  @Override
  public int compareTo(RStatement other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("RStatement(");
    boolean first = true;
  ...
  private static class RStatementStandardSchemeFactory implements SchemeFactory {
    public RStatementStandardScheme getScheme() {
      return new RStatementStandardScheme();
    }
  }

  private static class RStatementStandardScheme extends StandardScheme<RStatement> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, RStatement struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, RStatement struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class RStatementTupleSchemeFactory implements SchemeFactory {
    public RStatementTupleScheme getScheme() {
      return new RStatementTupleScheme();
    }
  }

  private static class RStatementTupleScheme extends TupleScheme<RStatement> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, RStatement struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, RStatement struct) throws org.apache.thrift.TException {
